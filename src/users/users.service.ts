...
export class UsersService {
  ...
  async create(createDto: CreateUserDto, file?: Express.Multer.File): Promise<User> {
    const { email, username, roleId, designation, expertise, ...rest } = createDto;
    ...
    // Handle expertise transformation
    const expertiseArray = this.handleExpertiseField(expertise);
  ...
  async updateUser(id: number, updateDto: UpdateUserDto, file?: Express.Multer.File) {
